...
def main():
    ...
    parser.add_argument(
        '--det-config',
        type=str,
        default='/workspace/str/psenet_160/my_psenet.py',
        help='Text detection config file.')
    parser.add_argument(
        '--det-ckpt',
        type=str,
        default='/workspace/str/psenet_160/latest.pth',
        help='Text detection checkpint file (local or url).')
    parser.add_argument(
        '--recog-config',
        type=str,
        default='/workspace/str/rbsan_200/my_robust_scanner.py' ,
        help='Text recognition config file.')
    parser.add_argument(
        '--recog-ckpt',
        type=str,
        default='/workspace/str/rbsan_200/latest.pth',
